...
_lr_productions = [
  ...
  ('condition -> expression','condition',1,'p_condition2','parser_cstr.py',273),
  ('comparison_operator -> EGAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',282),
  ('comparison_operator -> DIFF','comparison_operator',1,'p_comparison_operator','parser_cstr.py',283),
  ('comparison_operator -> INF','comparison_operator',1,'p_comparison_operator','parser_cstr.py',284),
  ('comparison_operator -> SUP','comparison_operator',1,'p_comparison_operator','parser_cstr.py',285),
  ('comparison_operator -> INFEQUAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',286),
  ('comparison_operator -> SUPEQUAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',287),
  ('expression -> expression_additive','expression',1,'p_expression_1','parser_cstr.py',294),
  ('expression -> expression SHIFTLEFT expression_additive','expression',3,'p_expression_2','parser_cstr.py',299),
  ('expression -> expression SHIFTRIGHT expression_additive','expression',3,'p_expression_3','parser_cstr.py',303),
  ('expression_additive -> expression_multiplicative','expression_additive',1,'p_expression_additive_1','parser_cstr.py',309),
  ('expression_additive -> expression_additive PLUS expression_multiplicative','expression_additive',3,'p_expression_additive_2','parser_cstr.py',314),
  ('expression_additive -> expression_additive MINUS expression_multiplicative','expression_additive',3,'p_additive_expression_3','parser_cstr.py',319),
  ('expression_multiplicative -> unary_expression','expression_multiplicative',1,'p_expression_multiplicative_1','parser_cstr.py',326),
  ('expression_multiplicative -> expression_multiplicative MULTI unary_expression','expression_multiplicative',3,'p_expression_multiplicative_2','parser_cstr.py',331),
  ('expression_multiplicative -> expression_multiplicative DIV unary_expression','expression_multiplicative',3,'p_expression_multiplicative_3','parser_cstr.py',336),
  ('expression_multiplicative -> expression_multiplicative MODULO unary_expression','expression_multiplicative',3,'p_multiplicative_expression_4','parser_cstr.py',341),
  ('unary_expression -> postfix_expression','unary_expression',1,'p_unary_expression_1','parser_cstr.py',348),
  ('unary_expression -> MINUS unary_expression','unary_expression',2,'p_unary_expression_2','parser_cstr.py',353),
  ('postfix_expression -> primary_expression','postfix_expression',1,'p_postfix_expression_1','parser_cstr.py',363),
  ('postfix_expression -> IDENT L_PARENTHESIS argument_expression_list R_PARENTHESIS','postfix_expression',4,'p_postfix_expression_2','parser_cstr.py',368),
  ('postfix_expression -> IDENT L_PARENTHESIS R_PARENTHESIS','postfix_expression',3,'p_postfix_expression_3','parser_cstr.py',373),
  ('argument_expression_list -> expression','argument_expression_list',1,'p_argument_expression_list_1','parser_cstr.py',380),
  ('argument_expression_list -> argument_expression_list COMMA expression','argument_expression_list',3,'p_argument_expression_list_2','parser_cstr.py',384),
  ('primary_expression -> IDENT','primary_expression',1,'p_primary_expression_1','parser_cstr.py',391),
  ('primary_expression -> CONST_INT','primary_expression',1,'p_primary_expression_2','parser_cstr.py',395),
  ('primary_expression -> CONST_STRING','primary_expression',1,'p_primary_expression_3','parser_cstr.py',399),
  ('primary_expression -> L_PARENTHESIS expression R_PARENTHESIS','primary_expression',3,'p_primary_expression_4','parser_cstr.py',403),
  ('primary_expression -> CHAR','primary_expression',1,'p_primary_expression_5','parser_cstr.py',407),
]
