...
_lr_productions = [
  ...
  ('program -> external_declaration','program',1,'p_program_1','parser_cstr.py',27),
  ('program -> program external_declaration','program',2,'p_program_2','parser_cstr.py',32),
  ('external_declaration -> declaration','external_declaration',1,'p_external_declaration_1','parser_cstr.py',39),
  ('external_declaration -> EXTERN declaration','external_declaration',2,'p_external_declaration_2','parser_cstr.py',43),
  ('external_declaration -> function-definition','external_declaration',1,'p_external_declaration_3','parser_cstr.py',49),
  ('function-definition -> type function_declarator compound_instruction','function-definition',3,'p_function','parser_cstr.py',55),
  ('declaration -> type declarator_list SEMI_COL','declaration',3,'p_declaration','parser_cstr.py',63),
  ('type -> INT','type',1,'p_type','parser_cstr.py',74),
  ('type -> STRING','type',1,'p_type','parser_cstr.py',75),
  ('declarator_list -> declarator','declarator_list',1,'p_declarator_list_1','parser_cstr.py',81),
  ('declarator_list -> declarator_list COMMA declarator','declarator_list',3,'p_declarator_list_2','parser_cstr.py',85),
  ('declaration_list -> declaration','declaration_list',1,'p_declaration_list_1','parser_cstr.py',91),
  ('declaration_list -> declaration_list declaration','declaration_list',2,'p_declaration_list_2','parser_cstr.py',95),
  ('declarator -> IDENT','declarator',1,'p_declarator','parser_cstr.py',101),
  ('declarator -> function_declarator','declarator',1,'p_declarator','parser_cstr.py',102),
  ('function_declarator -> IDENT L_PARENTHESIS R_PARENTHESIS','function_declarator',3,'p_function_declarator_1','parser_cstr.py',108),
  ('function_declarator -> IDENT L_PARENTHESIS parameter_list R_PARENTHESIS','function_declarator',4,'p_function_declarator_2','parser_cstr.py',112),
  ('parameter_list -> parameter_declaration','parameter_list',1,'p_parameter_list_1','parser_cstr.py',120),
  ('parameter_list -> parameter_list COMMA parameter_declaration','parameter_list',3,'p_parameter_list_2','parser_cstr.py',124),
  ('parameter_declaration -> type IDENT','parameter_declaration',2,'p_parameter_declaration','parser_cstr.py',130),
  ('instruction -> SEMI_COL','instruction',1,'p_instruction_1','parser_cstr.py',135),
  ('instruction -> compound_instruction','instruction',1,'p_instruction_2','parser_cstr.py',140),
  ('instruction -> expression_instruction','instruction',1,'p_instruction_2','parser_cstr.py',141),
  ('instruction -> iteration_instruction','instruction',1,'p_instruction_2','parser_cstr.py',142),
  ('instruction -> select_instruction','instruction',1,'p_instruction_2','parser_cstr.py',143),
  ('instruction -> jump_instruction','instruction',1,'p_instruction_2','parser_cstr.py',144),
  ('expression_instruction -> expression SEMI_COL','expression_instruction',2,'p_expression_instruction_1','parser_cstr.py',150),
  ('expression_instruction -> assignment SEMI_COL','expression_instruction',2,'p_expression_instruction_2','parser_cstr.py',154),
  ('assignment -> IDENT ASSIGNMENT expression','assignment',3,'p_assignment','parser_cstr.py',160),
  ('compound_instruction -> block_start declaration_list instruction_list block_end','compound_instruction',4,'p_compound_instruction_1','parser_cstr.py',179),
  ('compound_instruction -> block_start declaration_list block_end','compound_instruction',3,'p_compound_instruction_2','parser_cstr.py',183),
  ('compound_instruction -> block_start instruction_list block_end','compound_instruction',3,'p_compound_instruction_3','parser_cstr.py',187),
  ('compound_instruction -> block_start block_end','compound_instruction',2,'p_compound_instruction_4','parser_cstr.py',191),
  ('block_start -> LEFT_BRACKET','block_start',1,'p_block_start','parser_cstr.py',197),
  ('block_end -> RIGHT_BRACKET','block_end',1,'p_block_end','parser_cstr.py',207),
  ('instruction_list -> instruction','instruction_list',1,'p_instruction_list_1','parser_cstr.py',217),
  ('instruction_list -> instruction_list instruction','instruction_list',2,'p_instruction_list_2','parser_cstr.py',221),
  ('select_instruction -> cond_instruction instruction','select_instruction',2,'p_select_instruction_1','parser_cstr.py',227),
  ('select_instruction -> cond_instruction instruction ELSE instruction','select_instruction',4,'p_select_instruction_2','parser_cstr.py',232),
  ('cond_instruction -> IF L_PARENTHESIS condition R_PARENTHESIS','cond_instruction',4,'p_cond_instruction','parser_cstr.py',240),
  ('iteration_instruction -> WHILE L_PARENTHESIS condition R_PARENTHESIS instruction','iteration_instruction',5,'p_iteration_instruction_1','parser_cstr.py',246),
  ('iteration_instruction -> DO instruction WHILE L_PARENTHESIS condition R_PARENTHESIS SEMI_COL','iteration_instruction',7,'p_iteration_instruction_2','parser_cstr.py',251),
  ('iteration_instruction -> FOR L_PARENTHESIS assignment SEMI_COL condition SEMI_COL assignment R_PARENTHESIS instruction','iteration_instruction',9,'p_iteration_instruction_3','parser_cstr.py',256),
  ('jump_instruction -> RETURN expression SEMI_COL','jump_instruction',3,'p_jump_instruction','parser_cstr.py',263),
  ('condition -> expression comparison_operator expression','condition',3,'p_condition','parser_cstr.py',269),
  ('condition -> expression','condition',1,'p_condition2','parser_cstr.py',274),
  ('comparison_operator -> EGAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',283),
  ('comparison_operator -> DIFF','comparison_operator',1,'p_comparison_operator','parser_cstr.py',284),
  ('comparison_operator -> INF','comparison_operator',1,'p_comparison_operator','parser_cstr.py',285),
  ('comparison_operator -> SUP','comparison_operator',1,'p_comparison_operator','parser_cstr.py',286),
  ('comparison_operator -> INFEQUAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',287),
  ('comparison_operator -> SUPEQUAL','comparison_operator',1,'p_comparison_operator','parser_cstr.py',288),
  ('expression -> expression_additive','expression',1,'p_expression_1','parser_cstr.py',295),
  ('expression -> expression SHIFTLEFT expression_additive','expression',3,'p_expression_2','parser_cstr.py',300),
  ('expression -> expression SHIFTRIGHT expression_additive','expression',3,'p_expression_3','parser_cstr.py',304),
  ('expression_additive -> expression_multiplicative','expression_additive',1,'p_expression_additive_1','parser_cstr.py',310),
  ('expression_additive -> expression_additive PLUS expression_multiplicative','expression_additive',3,'p_expression_additive_2','parser_cstr.py',315),
  ('expression_additive -> expression_additive MINUS expression_multiplicative','expression_additive',3,'p_additive_expression_3','parser_cstr.py',320),
  ('expression_multiplicative -> unary_expression','expression_multiplicative',1,'p_expression_multiplicative_1','parser_cstr.py',327),
  ('expression_multiplicative -> expression_multiplicative MULTI unary_expression','expression_multiplicative',3,'p_expression_multiplicative_2','parser_cstr.py',332),
  ('expression_multiplicative -> expression_multiplicative DIV unary_expression','expression_multiplicative',3,'p_expression_multiplicative_3','parser_cstr.py',337),
  ('expression_multiplicative -> expression_multiplicative MODULO unary_expression','expression_multiplicative',3,'p_multiplicative_expression_4','parser_cstr.py',342),
  ('unary_expression -> postfix_expression','unary_expression',1,'p_unary_expression_1','parser_cstr.py',349),
  ('unary_expression -> MINUS unary_expression','unary_expression',2,'p_unary_expression_2','parser_cstr.py',354),
  ('postfix_expression -> primary_expression','postfix_expression',1,'p_postfix_expression_1','parser_cstr.py',364),
  ('postfix_expression -> IDENT L_PARENTHESIS argument_expression_list R_PARENTHESIS','postfix_expression',4,'p_postfix_expression_2','parser_cstr.py',369),
  ('postfix_expression -> IDENT L_PARENTHESIS R_PARENTHESIS','postfix_expression',3,'p_postfix_expression_3','parser_cstr.py',374),
  ('argument_expression_list -> expression','argument_expression_list',1,'p_argument_expression_list_1','parser_cstr.py',381),
  ('argument_expression_list -> argument_expression_list COMMA expression','argument_expression_list',3,'p_argument_expression_list_2','parser_cstr.py',385),
  ('primary_expression -> IDENT','primary_expression',1,'p_primary_expression_1','parser_cstr.py',392),
  ('primary_expression -> CONST_INT','primary_expression',1,'p_primary_expression_2','parser_cstr.py',396),
  ('primary_expression -> CONST_STRING','primary_expression',1,'p_primary_expression_3','parser_cstr.py',400),
  ('primary_expression -> L_PARENTHESIS expression R_PARENTHESIS','primary_expression',3,'p_primary_expression_4','parser_cstr.py',404),
  ('primary_expression -> CHAR','primary_expression',1,'p_primary_expression_5','parser_cstr.py',408),
]
